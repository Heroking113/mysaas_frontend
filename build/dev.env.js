...
export default merge(prodEnv, {
    ...
    LOCAL_DEV_PORT: JSON.stringify('8086'),
    AJAX_URL_PREFIX: JSON.stringify('http://appdev.paas-class.bktencent.com:8088'),
    AJAX_MOCK_PARAM: JSON.stringify('mock'),
    // 后台获取登录用户信息 API
    LOGIN_SERVICE_URL: JSON.stringify('http://appdev.paas-class.bktencent.com:8088'),
